...
ActiveRecord::Schema.define(version: 2020_05_21_205462) do
  ...
  create_table "spree_amazon_transactions", id: :serial, force: :cascade do |t|
    t.integer "order_id"
    t.string "order_reference"
    t.string "authorization_id"
    t.string "capture_id"
    t.datetime "closed_at"
    t.index ["order_id"], name: "index_spree_amazon_transactions_on_order_id"
    t.index ["order_reference"], name: "index_spree_amazon_transactions_on_order_reference"
  end
